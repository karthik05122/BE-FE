...
const ReviewerDashboard = () => {
  ...
  const pendingApprovals = tasks?.filter(
    (task) => task.status === 'Pending PMO approval'
  ) || [];
  ...
  return (
    <Box>
          ...
          <Card>
            <CardContent>
              <Box display="flex" alignItems="center" justifyContent="space-between">
                ...
                <Badge badgeContent={pendingEOs.length} color="info">
        ...
        <Grid item xs={12}>
          <Paper sx={{ p: 2 }}>
            <Typography variant="h6" gutterBottom>
              Tasks Pending PMO Approval
            </Typography>
            {pendingApprovals.length === 0 ? (
              <Alert severity="info">No tasks pending approval</Alert>
            ) : (
              <TableContainer>
                <Table>
                  <TableHead>
      ...
      {/* Executive Orders and Tasks */}
      <Grid container spacing={3}>
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 2 }}>
            <Typography variant="h6" gutterBottom>
              Executive Orders to Review
            </Typography>
            <TableContainer>
              <Table size="small">
                <TableHead>
